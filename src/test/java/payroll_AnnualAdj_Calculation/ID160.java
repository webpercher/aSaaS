...
/**
 * Calculate total amount of #id160(Salary/Allowance > Social Insurance Total Amount) 
 **/
public class ID160 extends TestBase{
	...
	@Test
	public void id160() throws Exception {
		//#id160=#id100(Salary/Allowance > Social Insurance Rate of #id69(n)=1) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=2) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=3) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=4) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=5) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=6) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=7) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=8) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=9) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=10) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=11) + #id100(Salary/Allowance > Social Insurance Rate of #id69(n)=12)
		...
		//get the value
		int actual = Integer.parseInt(driver.findElement(By.xpath(annualAdjustment.socialInsuranceTotalAmount.xpath)).getText().replace(",",""));
		//check the data
		if(id160==actual){
			System.out.println("id160 Pass");
		}else{
			System.out.println("id160 Failed");
			throw new Exception("Error of calculation, expected: <["+id160+"]> but was: <["+actual+"]> , " +
