...
/**
 * Calculate total amount of #id370(Salary/Bonus > Total Payment Total Amount) 
 **/
public class ID370 extends TestBase{
	...
	@Test
	public void id370() throws Exception {
		//#id370=#id310 + #id340
		...
		int id310 = (int) (Math.random()*100000000);
		//input the value			
		driver.findElement(By.xpath(annualAdjustment.formerJobPaymentTotalAmount.xpath)).sendKeys(String.valueOf(id310));
		driver.findElement(By.xpath(annualAdjustment.bonusDependentNumber_1.xpath)).click();
		Thread.sleep(3000);
				
		int id370 = id310+id340;
		//get the value
		int actual = Integer.parseInt(driver.findElement(By.xpath(annualAdjustment.annualTheirMinute1.xpath)).getText().replace(",",""));
		//check the data
		if(id370==actual){
			System.out.println("id370 Pass");
		}else{
			System.out.println("id370 Failed");
			throw new Exception("Error of calculation, expected: <["+id370+"]> but was: <["+actual+"]> , " +
