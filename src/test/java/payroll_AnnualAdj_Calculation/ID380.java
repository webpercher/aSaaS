...
/**
 * Calculate total amount of #id380(Salary/Bonus > Total Social Insurance Total Amount) 
 **/
public class ID380 extends TestBase{
	...
	@Test
	public void id380() throws Exception {
		//#id380=#id320 + #id350
		...
		int id320 = (int) (Math.random()*100000000);
		//input the value			
		driver.findElement(By.xpath(annualAdjustment.formerJobSocialInsuranceTotalAmount.xpath)).sendKeys(String.valueOf(id320));
		driver.findElement(By.xpath(annualAdjustment.bonusDependentNumber_1.xpath)).click();
		Thread.sleep(3000);
				
		int id380 = id320+id350;
		//get the value
		int actual = Integer.parseInt(driver.findElement(By.xpath(annualAdjustment.totalSocialInsuranceTotalAmount.xpath)).getText().replace(",",""));
		//check the data
		if(id380==actual){
			System.out.println("id380 Pass");
		}else{
			System.out.println("id380 Failed");
			throw new Exception("Error of calculation, expected: <["+id380+"]> but was: <["+actual+"]> , " +
