...
/**
 * Calculate total amount of #id390(Salary/Bonus > Total Calc Tax Total Amount) 
 **/
public class ID390 extends TestBase{
	...
	@Test
	public void id390() throws Exception {
		//#id390=#id330 + #id360
		...
		int id330 = (int) (Math.random()*100000000);
		//input the value			
		driver.findElement(By.xpath(annualAdjustment.formerJobCalculatedTaxTotalAmount.xpath)).sendKeys(String.valueOf(id330));
		driver.findElement(By.xpath(annualAdjustment.bonusDependentNumber_1.xpath)).click();
		Thread.sleep(3000);
				
		int id390 = id330+id360;
		//get the value
		int actual = Integer.parseInt(driver.findElement(By.xpath(annualAdjustment.annualTheirMinute2.xpath)).getText().replace(",",""));
		//check the data
		if(id390==actual){
			System.out.println("id390 Pass");
		}else{
			System.out.println("id390 Failed");
			throw new Exception("Error of calculation, expected: <["+id390+"]> but was: <["+actual+"]> , " +
