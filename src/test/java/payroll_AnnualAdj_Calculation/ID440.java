...
/**
 * #id440(Ditto Tax Amount Refund Collected Month > Refund Collected Tax Amount) is inputted and set [#id440] to [#id130] having #id430(Ditto Tax Amount Refund Collected Month > Month). 
 **/
public class ID440 extends TestBase{
	 ...
	 **/
	@Test
	public void id440_1_1_1() throws Exception {
		...
		//check the data
		if(id140==actual){
			System.out.println("id440_1_1_1 Pass");
		}else{
			System.out.println("id440_1_1_1 Failed");
	 ...
	 **/
	@Test
	public void id440_1_1_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("annualadjustment"));
		new WebDriverWait( driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(annualAdjustment.annualAdjPage.xpath)));
		changeAdjType("payroll");
		//(#id130(Salary/Allowance > Balance Tax Amount) of #id430(Ditto Tax Amount Refund Collected Month > Month) = 
		...
		//check the data
		if(id140==actual){
			System.out.println("id440_1_1_2 Pass");
		}else{
			System.out.println("id440_1_1_2 Failed");
			throw new Exception("Error of calculation, expected: <["+id140+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"actual = "+ actual+"\r\n"+
					"id130 = "+ id140+"\r\n"+
	 ...
	 **/
	@Test
	public void id440_1_2_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("annualadjustment"));
		new WebDriverWait( driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(annualAdjustment.annualAdjPage.xpath)));
		changeAdjType("payroll");
		//Else
		...
		//check the data
		if(id140==actual){
			System.out.println("id440_1_2_1 Pass");
		}else{
			System.out.println("id440_1_2_1 Failed");
			throw new Exception("Error of calculation, expected: <["+id140+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"actual = "+ actual+"\r\n"+
					"id130 = "+ id140+"\r\n"+
	 ...
	 **/
	@Test
	public void id440_2_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("annualadjustment"));
		new WebDriverWait( driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(annualAdjustment.annualAdjPage.xpath)));
		changeAdjType("bonus");
		//Else
		...
		//check the data
		if(id140==actual){
			System.out.println("id440_2_1 Pass");
		}else{
			System.out.println("id440_2_1 Failed");
			throw new Exception("Error of calculation, expected: <["+id140+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"actual = "+ actual+"\r\n"+
					"id130 = "+ id140+"\r\n"+
	 ...
	 **/
	@Test
	public void id440_3_1_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("annualadjustment"));
		new WebDriverWait( driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(annualAdjustment.annualAdjPage.xpath)));
		changeAdjType("other");
		//(#id130(Salary/Allowance > Balance Tax Amount) of #id430(Ditto Tax Amount Refund Collected Month > Month)= 
		...
		//check the data
		if(id140==actual){
			System.out.println("id440_3_1_1 Pass");
		}else{
			System.out.println("id440_3_1_1 Failed");
			throw new Exception("Error of calculation, expected: <["+id140+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"actual = "+ actual+"\r\n"+
					"id130 = "+ id140+"\r\n"+
	 ...
	 **/
	@Test
	public void id440_3_1_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("annualadjustment"));
		new WebDriverWait( driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(annualAdjustment.annualAdjPage.xpath)));
		changeAdjType("other");
		//(#id130(Salary/Allowance > Balance Tax Amount) of #id430(Ditto Tax Amount Refund Collected Month > Month) = 
		...
		//check the data
		if(id140==actual){
			System.out.println("id440_3_1_2 Pass");
		}else{
			System.out.println("id440_3_1_2 Failed");
			throw new Exception("Error of calculation, expected: <["+id140+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"actual = "+ actual+"\r\n"+
					"id130 = "+ id140+"\r\n"+
	 ...
	 **/
	@Test
	public void id440_3_2_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("annualadjustment"));
		new WebDriverWait( driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(annualAdjustment.annualAdjPage.xpath)));
		changeAdjType("other");
		//Else
		...
		//check the data
		if(id140==actual){
			System.out.println("id440_3_2_1 Pass");
		}else{
			System.out.println("id440_3_2_1 Failed");
			throw new Exception("Error of calculation, expected: <["+id140+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"actual = "+ actual+"\r\n"+
					"id130 = "+ id140+"\r\n"+
