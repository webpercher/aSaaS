...
/**
 * Calculate total amount of #id900(Calculated Annual Tax Amount)
 * If AnnualAdjustmentInformation#annualAdjestmentFlag is "TRUE" and WithholdingIncomeTaxLedger#totalAmount =< 20,000,000 , show Calculation when #id890(TaxableIncomeAmount) is altered
 **/
public class ID900 extends TestBase{
	 ...
	 *【10】= 0.05
	 *【20】= 0
	 *1950000 ＜ #id890 ≦ 3300000
	 *【10】= 0.1
	 *【20】= 97500
	 *3300000 ＜ #id890 ≦ 6950000
	 *【10】= 0.2
	 *【20】= 427500
	 *6950000 ＜ #id890 ≦ 9000000
	 *【10】= 0.23
	 *【20】= 636000
	 *9000000 ＜ #id890 ≦ 16920000
	 *【10】= 0.33
	 *【20】= 1536000
	 **/
	@Test
	public void id890_1() throws Exception {
		...
		//get the value
		int actual = Integer.parseInt(driver.findElement(By.xpath(annualAdjustment.calculatedAnnualTaxAmount.xpath)).getText().replace(",",""));
		//check the data
		if(id900==actual){
			System.out.println("id900_1 Pass");
		}else{
			System.out.println("id900_1 Failed");
			throw new Exception("Error of calculation, expected: <["+id900+"]> but was: <["+actual+"]> , " +
