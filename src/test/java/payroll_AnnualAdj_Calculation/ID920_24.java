 ...
 **/
public class ID920_24 extends TestBase{
	 ...
	 **/
	@Test
	public void id920_24_1() throws Exception {
		//id830
		int id830 = 380000;
		//id750
		...
		if(id920<100){
			...
			id920 = Integer.parseInt(String.valueOf(id920).substring(0,String.valueOf(id920).length()-2)+"00");
		}
		//check the data
		if(id920==actual){
			System.out.println("id920_24_1 Pass");
		}else{
			System.out.println("id920_24_1 Failed");
