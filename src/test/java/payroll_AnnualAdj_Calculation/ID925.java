...
/**
 * Calculate total amount of #id920(Annual Adjustment Tax Amount (21 × 102.1%) )
 ...
 **/
public class ID925 extends TestBase{
	 ...
	 **/
	@Test
	public void id925_1() throws Exception {
		//id830
		int id830 = 380000;
		//id750
		...
		new WebDriverWait( driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(annualAdjustment.annualAdjPage.xpath)));
		//get the value
		int actual = Integer.parseInt(driver.findElement(By.xpath(annualAdjustment.annualAdjustmentTaxAmount21.xpath)).getText().replace(",",""));
		//id920 = (#id900 - #id910)
		...
		//check the data
		if(id925==actual){
			System.out.println("id925_1 Pass");
		}else{
			System.out.println("id925_1 Failed");
			throw new Exception("Error of calculation, expected: <["+id925+"]> but was: <["+actual+"]> , " +
