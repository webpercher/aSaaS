 ...
 **/
public class ID940_24 extends TestBase{
	 ...
	 **/
	@Test
	public void id940_24_1() throws Exception {
		//id830
		int id830 = 380000;
		//id750
		...
		//#id940=(#id920 - #id740)
		String id940 = String.valueOf(id920-id740);
		//check the data
		if(id940.equals("0")){
			id940 = "";
		}
		if(id940.equals(actual)){
			System.out.println("id940_24_1 Pass");
		}else{
			System.out.println("id940_24_1 Failed");
