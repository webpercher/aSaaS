...
/**
 * Calculate total amount of #id940(Balance Excessive or Deficit Amount)
 * If AnnualAdjustmentInformation#annualAdjestmentFlag is "TRUE" and WithholdingIncomeTaxLedger#totalAmount =< 20,000,000, show Calculation when either #id920(Annual Adjustment Tax Amount) or #id740(Total Tax Amount)) is altered
 **/
public class ID940_25 extends TestBase{
	...
	/**
	 * #id940=(#id925(Annual Adjustment Tax Amount (21 × 102.1%) ) - #id740(Total Tax Amount))
	 **/
	@Test
	public void id940_25_1() throws Exception {
		//id830
		int id830 = 380000;
		//id750
		...
		//#id925 = #id920 × 1.021
		//※Round down to the nearest 100yen (i.e. 123456 gets rounded to 123400)
		int id925 = Integer.parseInt(String.valueOf(id920*1.021).split("\\.")[0]);
		if(id925<100){
			id925 = 0;
		}else{
			id925 = Integer.parseInt(String.valueOf(id925).substring(0,String.valueOf(id925).length()-2)+"00");
		}
		//id740 = calculatedTaxAmount
		...
		Thread.sleep(2000);
		//get data
		int id740 = Integer.parseInt(driver.findElement(By.xpath(annualAdjustment.TotalTaxAmount.xpath)).getText().replace(",",""));
		//get the value
		String actual = driver.findElement(By.xpath(annualAdjustment.balanceExcessiveOrDeficitAmount.xpath)).getText().replace(",","");
		//#id940=(#id925 - #id740)
		String id940 = String.valueOf(id925-id740);
		//check the data
		if(id940.equals("0")){
			id940 = "";
		}
		if(id940.equals(actual)){
			System.out.println("id940_25_1 Pass");
		}else{
			System.out.println("id940_25_1 Failed");
			throw new Exception("Error of calculation, expected: <["+id940+"]> but was: <["+actual+"]> , " +
