 ...
 **/
public class generalContributionsAmount extends TestBase{
	 ...
	 **/
	@Test
	public void generalContributionsAmount_1() throws Exception {
		...
		//get value
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.generalContributionsAmount.xpath)).getText();
		//workerAccidentInsurance = workerAccidentTotalInsurance/1000
		int generalContributionsAmount = (int)Math.floor(Double.valueOf(String.valueOf(totalamount))/1000);
		//check the data
		if(Common.formatNum(String.valueOf(generalContributionsAmount)).equals(actual)){
			System.out.println("generalContributionsAmount_1 Pass");
		}else{
			System.out.println("generalContributionsAmount_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(generalContributionsAmount))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(generalContributionsAmount))+"\r\n"+
