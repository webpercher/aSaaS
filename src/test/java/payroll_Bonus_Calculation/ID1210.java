...
public class ID1210 extends TestBase {
	...
	public void id1210_1() throws Exception {
		...
		// input id1220
		int id1220 = 5455555;
		int id390 = new Random().nextInt(100);
		...
		Thread.sleep(10000);
		// check the result
		System.out.println("id390 + total == " + (id390 + total));
		if (Integer.parseInt(driver
				.findElement(By.xpath(bonusPaymentStatements.GeneralBonus2.xpath)).getText()
				.replace(",", "")) == ((id390 + total) / 1000 * 1000)) {
			System.out.println("id1210_1 Passed");
		} else {
			...
			throw new Exception("Error of calculation, expected: <["
					...
					+ Integer.parseInt(driver
							.findElement(By.xpath(bonusPaymentStatements.GeneralBonus2.xpath))
							.getText().replace(",", ""))
					+ "]> , "
	...
	@Test
	public void id1210_2() throws Exception {
		...
		// input id1220
		int id1220 = 5455555;
		int id390 = new Random().nextInt(100) + 1500000;
		for (int i = 0; i < 10; i++) {
			driver.findElement(By.xpath(bonusPaymentStatements.edit.xpath)).click();
		}
		...
		if (Integer.parseInt(driver
				.findElement(By.xpath(bonusPaymentStatements.GeneralBonus2.xpath)).getText()
				.replace(",", "")) == 1500000) {
			System.out.println("id1210_2 Passed");
		} else {
			System.out.println("id1210_2 Failed");
			throw new Exception("Error of calculation, expected: <["
					+ "1500000"
					+ "]> but was: <["
					+ Integer.parseInt(driver
