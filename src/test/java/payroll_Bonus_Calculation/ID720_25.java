...
public class ID720_25 extends TestBase {
	 ...
	 */
	@Test
	public void id720_1() throws Exception {
		// input id1300
		...
		int b = total
				- Integer.parseInt(driver
						...
						.getText().replace(",", ""));
		int id720 = Integer.parseInt(driver
				.findElement(By.xpath(bonusPaymentStatements.incomeTax.xpath))
				.getAttribute("value").replace(",", ""));
		// check the result
		if (id720 == (b * 1000000)) {
			System.out.println("id720_1 Passed");
		} else {
			System.out.println("id720_1 Failed");
			throw new Exception("b=" + b + ";id720=" + id720);
		}
	}
	 ...
	 */
	@Test
	public void id720_2_1() throws Exception {
		
	}

	// Calculate id710
	public void CalculateID710() throws Exception {
		// random 11 itmes
