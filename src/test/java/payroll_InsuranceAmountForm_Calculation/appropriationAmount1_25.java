 ...
 **/
public class appropriationAmount1_25 extends TestBase{
	 ...
	 * If (<estimatedInsuranceAmount> - <totalAmount type="0" displayOrder="1">) ≦ (<totalAmount type="1" displayOrder="1">){
	 * (<estimatedInsuranceAmount> - <totalAmount type="0" displayOrder="1">)
	 **/
	@Test
	public void appropriationAmount1_1_1() throws Exception {
		...
		int totalAmount1_displayOrder = (int)(Math.random()*1000000+1000);
		int estimatedInsuranceAmount =  (int)(Math.random()*(totalAmount0_displayOrder+totalAmount1_displayOrder));
		...
		//get value
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.appropriationAmount1.xpath)).getText();
		//<estimatedInsuranceAmount> - <totalAmount type="0" displayOrder="1">
		String appropriationAmount1 = String.valueOf(estimatedInsuranceAmount-totalAmount0_displayOrder);
		if(Integer.parseInt(appropriationAmount1)<=0){
			appropriationAmount1 = "";
		}
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount1)).equals(actual)){
			System.out.println("appropriationAmount1_1_1 Pass");
		}else{
			System.out.println("appropriationAmount1_1_1 Failed");
	 ...
	 * If (<appropriationIntent> is '1'){
	 * Else {
	 * (<totalAmount type="1" displayOrder="1">)
	 **/
	@Test
	public void appropriationAmount1_1_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.appropriationAmount1.xpath)).getText();
		//check the data
		if(Common.formatNum(String.valueOf(totalAmount1_displayOrder)).equals(actual)){
			System.out.println("appropriationAmount1_1 Pass");
		}else{
			System.out.println("appropriationAmount1_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(totalAmount1_displayOrder))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(totalAmount1_displayOrder))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
					"estimatedInsuranceAmount = "+ estimatedInsuranceAmount+"\r\n"+
					"rate_displayOrder = "+ rate_displayOrder+"\r\n"+
					"actual = "+ actual);
	 ...
	 * If (<estimatedInsuranceAmount> - <totalAmount type="0" displayOrder="1">) ≦ (<totalAmount type="0" displayOrder="6">){
	 * (<totalAmount type="1" displayOrder="1">)
	 **/
	@Test
	public void appropriationAmount1_2_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount1)).equals(actual)){
			System.out.println("appropriationAmount1_2_1 Pass");
		}else{
			System.out.println("appropriationAmount1_2_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount1))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount1))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 **/
	@Test
	public void appropriationAmount1_2_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(Common.formatNum(String.valueOf(totalAmount1_displayOrder)).equals(actual)){
			System.out.println("appropriationAmount1_2_2 Pass");
		}else{
			System.out.println("appropriationAmount1_2_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(totalAmount1_displayOrder))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(totalAmount1_displayOrder))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 * If (<estimatedInsuranceAmount> - <totalAmount type="0" displayOrder="1">) ≦ (<totalAmount type="1" displayOrder="1"> + <totalAmount type="0" displayOrder="6">){
	 * (<estimatedInsuranceAmount> - <totalAmount type="0" displayOrder="1">)
	 **/
	@Test
	public void appropriationAmount1_3_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount1)).equals(actual)){
			System.out.println("appropriationAmount1_3_1 Pass");
		}else{
			System.out.println("appropriationAmount1_3_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount1))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount1))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 * Else if (<appropriationIntent> is '3'){
	 * Else
	 * (<totalAmount type="1" displayOrder="1"> + <totalAmount type="0" displayOrder="6">)
	 **/
	@Test
	public void appropriationAmount1_3_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		double rate_displayOrder = 1;
		//input the value 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountFormSubject3Amount.xpath)).sendKeys(String.valueOf(totalAmount0_displayOrder/2));
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountFormSubject3Rate.xpath)).sendKeys(String.valueOf(rate_displayOrder));
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountFormSubject3Amount.xpath)).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountFormSubject3Amount6.xpath)).click();
		...
		//check the data
		if(Common.formatNum(String.valueOf(totalAmount1_displayOrder)).equals(actual)){
			System.out.println("appropriationAmount1_3_2 Pass");
		}else{
			System.out.println("appropriationAmount1_3_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(totalAmount1_displayOrder))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(totalAmount1_displayOrder))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 **/
	@Test
	public void appropriationAmount1_4_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(actual.isEmpty()){
			System.out.println("appropriationAmount1_4_1 Pass");
		}else{
			System.out.println("appropriationAmount1_4_1 Failed");
