 ...
 **/
public class appropriationAmount2 extends TestBase{
	...
	/**
	 * If <delayedPayment> is "1"
	 * <totalAmount type="1" displayOrder="1"> 
	 **/
	@Test
	public void appropriationAmount2_1_1() throws Exception {
		...
		Thread.sleep(1000);
		//get value
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.appropriationAmount2.xpath)).getText();
		//check the data
		if(Common.formatNum(String.valueOf(totalAmount0_displayOrder)).equals(actual)){
			System.out.println("appropriationAmount2_1_1 Pass");
		}else{
			System.out.println("appropriationAmount2_1_1 Failed");
	 ...
	 **/
	@Test
	public void appropriationAmount2_2_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		int appropriationAmount2 = totalAmount0_displayOrder/3;
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount2)).equals(actual)){
			System.out.println("appropriationAmount2_2_1 Pass");
		}else{
			System.out.println("appropriationAmount2_2_1 Failed");
	 ...
	 **/
	@Test
	public void appropriationAmount2_2_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		int appropriationAmount2 = (int)(Math.floor(Double.valueOf(String.valueOf(totalAmount0_displayOrder))/3)+1);
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount2)).equals(actual)){
			System.out.println("appropriationAmount2_2_2 Pass");
		}else{
			System.out.println("appropriationAmount2_2_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount2))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount2))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 **/
	@Test
	public void appropriationAmount2_2_3() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		int appropriationAmount2 = (int)(Math.floor(Double.valueOf(String.valueOf(totalAmount0_displayOrder))/3)+2);
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount2)).equals(actual)){
			System.out.println("appropriationAmount2_2_3 Pass");
		}else{
			System.out.println("appropriationAmount2_2_3 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount2))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount2))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 **/
	@Test
	public void appropriationAmount2_2_4() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.appropriationAmount2.xpath)).getText();
		//Set blank
		String appropriationAmount2 = "";
		//check the data
		if(appropriationAmount2.equals(actual)){
			System.out.println("appropriationAmount2_2_4 Pass");
		}else{
			System.out.println("appropriationAmount2_2_4 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount2))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount2))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 **/
	@Test
	public void appropriationAmount2_3_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(appropriationAmount2.equals(actual)){
			System.out.println("appropriationAmount2_3_1 Pass");
		}else{
			System.out.println("appropriationAmount2_3_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount2))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount2))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
