 ...
 **/
public class appropriationAmount4 extends TestBase{
	 ...
	 **/
	@Test
	public void appropriationAmount4_1_1() throws Exception {
		...
		Thread.sleep(1000);
		//get value
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.appropriationAmount4.xpath)).getText();
		//<totalAmount type="1" displayOrder="1"> / 3
		int appropriationAmount4 = totalAmount0_displayOrder/3;
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount4)).equals(actual)){
			System.out.println("appropriationAmount4_1_1 Pass");
		}else{
			System.out.println("appropriationAmount4_1_1 Failed");
	 ...
	 **/
	@Test
	public void appropriationAmount4_1_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		int appropriationAmount4 = (int)(Math.floor(Double.valueOf(String.valueOf(totalAmount0_displayOrder))/3));
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount4)).equals(actual)){
			System.out.println("appropriationAmount4_1_2 Pass");
		}else{
			System.out.println("appropriationAmount4_1_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount4))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount4))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 **/
	@Test
	public void appropriationAmount4_1_3() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount4)).equals(actual)){
			System.out.println("appropriationAmount4_1_3 Pass");
		}else{
			System.out.println("appropriationAmount4_1_3 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount4))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount4))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 **/
	@Test
	public void appropriationAmount4_1_4() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.appropriationAmount4.xpath)).getText();
		//Set blank
		String appropriationAmount4 = "";
		//check the data
		if(appropriationAmount4.equals(actual)){
			System.out.println("appropriationAmount4_1_4 Pass");
		}else{
			System.out.println("appropriationAmount4_1_4 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount4))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount4))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
	 ...
	 **/
	@Test
	public void appropriationAmount4_2_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(appropriationAmount4.equals(actual)){
			System.out.println("appropriationAmount4_2_1 Pass");
		}else{
			System.out.println("appropriationAmount4_2_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount4))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount4))+"\r\n"+
					"totalAmount0_displayOrder = "+ totalAmount0_displayOrder+"\r\n"+
