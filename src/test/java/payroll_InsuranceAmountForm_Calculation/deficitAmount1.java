 ...
 **/
public class deficitAmount1 extends TestBase{
	 ...
	 **/
	@Test
	public void deficitAmount1_1() throws Exception {
		...
		Thread.sleep(1000);
		//get value
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.deficitAmount1.xpath)).getText();
		//<totalAmount type="0" displayOrder="1"> - <estimatedInsuranceAmount>
		...
		//check the data
		if(Common.formatNum(String.valueOf(deficitAmount1)).equals(actual)){
			System.out.println("deficitAmount1_1 Pass");
		}else{
			System.out.println("deficitAmount1_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(deficitAmount1))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(deficitAmount1))+"\r\n"+
