 ...
 **/
public class deficitAmount5 extends TestBase{
	...
	/**
	 * <appropriationAmount displayOrder="5"> - <refundAmount displayOrder="5">
	 **/
	@Test
	public void deficitAmount5_1() throws Exception {
		...
		//get value 
		String appropriationAmount5 = driver.findElement(By.xpath(socialInsuranceCalculation.appropriationAmount5.xpath)).getText().replace(",","");
		//get value
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.deficitAmount5.xpath)).getText();
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount5)).equals(actual)){
			System.out.println("deficitAmount5_1 Pass");
		}else{
			System.out.println("deficitAmount5_1 Failed");
