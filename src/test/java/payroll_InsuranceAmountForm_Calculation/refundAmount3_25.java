 ...
 **/
public class refundAmount3_25 extends TestBase{
	...
	/**
	 * Else if (<appropriationIntent> is disabled and blank){
	 * <totalAmount type="0" displayOrder="6">
	 **/
	@Test
	public void refundAmount3_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		if(Common.formatNum(String.valueOf(totalAmount0_displayOrder)).equals(actual)){
			System.out.println("refundAmount3_2 Pass");
		}else{
			System.out.println("refundAmount3_2 Failed");
	 ...
	 **/
	@Test
	public void refundAmount3_3() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(Common.formatNum(String.valueOf(totalAmount0_displayOrder)).equals(actual)){
			System.out.println("refundAmount3_3 Pass");
		}else{
			System.out.println("refundAmount3_3 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(totalAmount0_displayOrder))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(totalAmount0_displayOrder))+"\r\n"+
					"actual = "+ actual);
	 ...
	 * <totalAmount type="0" displayOrder="6"> - <generalAppropriationAmount displayOrder="3">
	 **/
	@Test
	public void refundAmount3_4() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//<totalAmount type="0" displayOrder="6"> - <generalAppropriationAmount displayOrder="3">
		int refundAmount3 = totalAmount0_displayOrder-1;
		
		//get value
		String actual = driver.findElement(By.xpath(socialInsuranceCalculation.refundAmount3.xpath)).getText();
		//check the data
		if(Common.formatNum(String.valueOf(refundAmount3)).equals(actual)){
			System.out.println("refundAmount3_4 Pass");
		}else{
			System.out.println("refundAmount3_4 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(refundAmount3))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(refundAmount3))+"\r\n"+
					"actual = "+ actual);
		}
		//close
		driver.findElement(By.xpath(socialInsuranceCalculation.close.xpath)).click();
	 ...
	 **/
	@Test
	public void refundAmount3_5() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(Common.formatNum(String.valueOf(refundAmount3)).equals(actual)){
			System.out.println("refundAmount3_5 Pass");
		}else{
			System.out.println("refundAmount3_5 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(refundAmount3))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(refundAmount3))+"\r\n"+
					"actual = "+ actual);
	 ...
	 **/
	@Test
	public void refundAmount3_6() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(actual.isEmpty()){
			System.out.println("refundAmount3_6 Pass");
		}else{
			System.out.println("refundAmount3_6 Failed");
			throw new Exception("Error of calculation, expected: <[]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+"\r\n"+
					"actual = "+ actual);
