 ...
 **/
public class refundAmount5_25 extends TestBase{
	 ...
	 **/
	@Test
	public void refundAmount5_1_1() throws Exception {
		...
		if(Common.formatNum(String.valueOf(appropriationAmount5)).equals(actual)){
			System.out.println("refundAmount5_1_1 Pass");
		}else{
			System.out.println("refundAmount5_1_1 Failed");
	 ...
	 **/
	@Test
	public void refundAmount5_1_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(actual.isEmpty()){
			System.out.println("refundAmount5_1_2 Pass");
		}else{
			System.out.println("refundAmount5_1_2 Failed");
	 ...
	 **/
	@Test
	public void refundAmount5_2_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(actual.isEmpty()){
			System.out.println("refundAmount5_2_1 Pass");
		}else{
			System.out.println("refundAmount5_2_1 Failed");
			throw new Exception("Error of calculation, expected: <[]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+"\r\n"+
					"refundAmount2 = "+ refundAmount2+"\r\n"+
	 ...
	 * If (<appropriationAmount displayOrder="1"> - <refundAmount displayOrder="2"> - <refundAmount displayOrder="4"> - <generalAppropriationAmount displayOrder="3">) ＞ <appropriationAmount displayOrder="5"> {
	 * <appropriationAmount displayOrder="5">
	 **/
	@Test
	public void refundAmount5_3_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(Common.formatNum(String.valueOf(appropriationAmount5)).equals(actual)){
			System.out.println("refundAmount5_3_1 Pass");
		}else{
			System.out.println("refundAmount5_3_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(appropriationAmount5))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(appropriationAmount5))+"\r\n"+
					"appropriationAmount4 = "+ appropriationAmount4+"\r\n"+
	 ...
	 **/
	@Test
	public void refundAmount5_3_2() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(actual.isEmpty()){
			System.out.println("refundAmount5_3_2 Pass");
		}else{
			System.out.println("refundAmount5_3_2 Failed");
			throw new Exception("Error of calculation, expected: <[]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = \r\n"+
					"appropriationAmount4 = "+ appropriationAmount4+"\r\n"+
	 ...
	 **/
	@Test
	public void refundAmount5_4_1() throws Exception {
		Common.forwardToPage(topPage.projectID.getDatas().get("socialinsurancecalculation"));
		new WebDriverWait(driver, 30).until(ExpectedConditions.presenceOfElementLocated(By.xpath(socialInsuranceCalculation.BaseAmountPayrollSummarySheet.xpath)));
		//forward to BaseAmountPayrollSummarySheet page 
		driver.findElement(By.xpath(socialInsuranceCalculation.InsuranceAmountForm.xpath)).click();
		...
		//check the data
		if(actual.isEmpty()){
			System.out.println("refundAmount5_4_1 Pass");
		}else{
			System.out.println("refundAmount5_4_1 Failed");
			throw new Exception("Error of calculation, expected: <[]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+"\r\n"+
					"appropriationAmount4 = "+ appropriationAmount4+"\r\n"+
