...
/**
 * Display the calculated value of taxable payment amount.
 **/
public class ID1200 extends TestBase{
	...
	public void id1200_1() throws Exception {
		...
		//Y(taxable total of allowance amount) = Sum of the voluntary allowance amount that 'withholding income tax' of VoluntaryItemAmount#allowanceSetting is off among #id410,#id430,#id450,#id470,#id490,#id510,#id530,#id550,#id570,#id590,#id610.
		int Y = id410+id430+id450+id470+id490+id510;
		//Z(taxable commuting allowance) =(#id620 - {PaySlip#commutingAllowanceNoneTaxableAmountId -> CommutingAllowanceNoneTaxableAmount#noneTaxableAmount }
		//※ If　 Z 　=< 0,　 Z 　=0
		int Z = id620-noneTaxableAmount;
		if(Z<=0){
			Z = 0;
		}
		//#id1200 = #id390(basic salary) + Y + Z + #id630(overtime work allowance) - #id640(no work deduction amount)
		id1200 = id390+Y+Z+id630-id640;
		//get value
		String actual = driver.findElement(By.xpath(paymentStatements.taxablePayment.xpath)).getText();
		//check the data
		if(Common.formatNum(String.valueOf(id1200)).equals(actual)){
			System.out.println("id1200_1 Pass");
		}else{
			System.out.println("id1200_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id1200))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(id1200))+"\r\n"+
					"actual = "+ actual);
		}
		//close
	 ...
	 **/
	@Test
	public void id1200_2() throws Exception {
		//lock the month
		driver.findElement(By.xpath(paymentStatements.lockMonth.xpath)).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath(paymentStatements.definition.xpath)).click();
		Thread.sleep(2000);
		//get value
		String actual = driver.findElement(By.xpath(paymentStatements.taxablePayment.xpath)).getText();
		//check the data
		if(Common.formatNum(String.valueOf(id1200)).equals(actual)){
			System.out.println("id1200_2 Pass");
		}else{
			System.out.println("id1200_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id1200))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(id1200))+"\r\n"+
					"actual = "+ actual);
