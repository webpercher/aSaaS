...
/**
 * Display the calculated amount of nursing insurance. 
 **/
public class ID670 extends TestBase{
	...
	/**
	 * If Employee#fixedAmountNursingInsuranceFlag is false
	 * If ClientSocialInsurance#healthInsuranceType='kyokai'
	 **/
	@Test
	public void id670_1_1() throws Exception {
		...
		//get value
		String actual = driver.findElement(By.xpath(paymentStatements.careInsurance.xpath)).getAttribute("value");
		...
		if(Common.formatNum(String.valueOf(expected)).equals(actual)){
			System.out.println("id670_1_1 Pass");
		}else{
			System.out.println("id670_1_1 Failed");
	 ...
	 **/
	@Test
	public void id670_1_2() throws Exception {
		...
		//check the data
		if(Common.formatNum(String.valueOf(expected)).equals(actual)){
			System.out.println("id670_1_2 Pass");
		}else{
			System.out.println("id670_1_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(expected))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(expected))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 **/
	@Test
	public void id670_1_3() throws Exception {
		...
		//check the data
		if(Common.formatNum(String.valueOf(expected)).equals(actual)){
			System.out.println("id670_1_3 Pass");
		}else{
			System.out.println("id670_1_3 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(expected))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(expected))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	...
	public static String changeEmployeeInfo(WebDriver driver,String type,String value) throws Exception{
		...
		if(type=="false"){
			if(driver.findElement(By.xpath(employeeSetting.fixedAmountNursingInsurance.xpath)).isSelected()){
				driver.findElement(By.xpath(employeeSetting.fixedAmountNursingInsurance.xpath)).click();
				Thread.sleep(1000);
			}
		}else{
			if(!driver.findElement(By.xpath(employeeSetting.fixedAmountNursingInsurance.xpath)).isSelected()){
			...
			//input the value
			Common.clear(driver,employeeSetting.fixedAmountNursingInsurance_input.xpath);
			driver.findElement(By.xpath(employeeSetting.fixedAmountNursingInsurance_input.xpath)).sendKeys(value);
			Thread.sleep(1000);
		}
		//input the value
	...
	public static String changeCompanyInfo(WebDriver driver,String type) throws Exception{
		...
		if(type=="kyokai"){
			...
			Common.clear(driver,clientSetting.healthInsuranceProportion_input.xpath);
			driver.findElement(By.xpath(clientSetting.healthInsuranceProportion_input.xpath)).sendKeys(num.substring(0,num.indexOf(".")+3));
			Thread.sleep(1000);
			...
			Common.clear(driver,clientSetting.healthInsuranceProportion_other.xpath);
			driver.findElement(By.xpath(clientSetting.healthInsuranceProportion_other.xpath)).sendKeys(num);
			Thread.sleep(1000);
			Common.clear(driver,clientSetting.careInsurance_paymentMonth.xpath);
			driver.findElement(By.xpath(clientSetting.careInsurance_paymentMonth.xpath)).sendKeys("4");
			Thread.sleep(1000);
		...
		driver.findElement(By.xpath(clientSetting.save.xpath)).click();
		Thread.sleep(3000);
		String result = driver.findElement(By.xpath(clientSetting.healthInsuranceProportion.xpath)).getText();
		if(type=="other"){
			result = driver.findElement(By.xpath(clientSetting.healthInsuranceProportion_other_dis.xpath)).getText();
		}
		Common.isNotPending();
