...
/**
 * Display the sum of each social insurance amount.
 **/
public class ID710 extends TestBase{
	...
	/**
	 * #id710 = #id660(health insurance amount)＋#id670(nursing insurance amount)＋#id680(social security amount)＋#id690(pension funds amount)＋#id700(unemployment insurance amount) + #id890(adjustment amount of social insurance)
	 **/
	@Test
	public void id710_1() throws Exception {
		...
		//check the data
		if(Common.formatNum(String.valueOf(sum)).equals(actual)){
			System.out.println("id710_1 Pass");
		}else{
			System.out.println("id710_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(sum))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(sum))+"\r\n"+
					"actual = "+ actual+"\r\n"+
					"id660 ="+ id660+"\r\n"+
					"id670 ="+ id670+"\r\n"+
					"id680 ="+ id680+"\r\n"+
