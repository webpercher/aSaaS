 ...
 * + #id630 - #id640 - #id710
 **/
public class ID720_25 extends TestBase{
	 ...
	 **/
	@Test
	public void id720_25_1_1() throws Exception {
		...
		//#id720= (WithholdingTaxAmount#otuTaxAmount - Employee#dependentsNumber×1610) rounded (half up) to the nearest 10. If the result amount < 0, 0. 
		int id720 =  Math.round(otsuTaxAmount-dependentsNumber*1610);
		if(id720<0){
			id720 = 0;
		}
		//get value
		...
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_1_1 Pass");
		}else{
			System.out.println("id720_25_1_1 Failed");
	 ...
	 **/
	@Test
	public void id720_25_1_2_1() throws Exception {
		dependentsNumber = changeEmployeeInfo(driver,"OTU","");
		...
		////If V < 1,010,000 yen
		//result = ( V ×WithholdingTaxAmount#otuSpecialTaxRate - Employee#dependentsNumber×1610)
		//#id720 = result rounded down after the decimal point. If the result amount < 0, 0. 
		int id720 =  (int)Math.floor(V*specialOtsuRate-dependentsNumber*1610);
		if(id720<0){
			id720 = 0;
		}
		//get value
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_1_2_1 Pass");
		}else{
			System.out.println("id720_25_1_2_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 **/
	@Test
	public void id720_25_1_2_2() throws Exception {
		dependentsNumber = changeEmployeeInfo(driver,"OTU","");
		...
		//+ ( V - 1010000) × WithholdingTaxAmount#otuSpecialTaxRate - Employee#dependentsNumber×1610 )
		//#id720 = result rounded down after the decimal point. If the result amount < 0, 0. 
		int id720 =  (int)Math.floor(otsuTaxAmount+(V-1010000)*specialOtsuRate-dependentsNumber*1610);
		if(id720<0){
			id720 = 0;
		}
		//get value
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_1_2_2 Pass");
		}else{
			System.out.println("id720_25_1_2_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 **/
	@Test
	public void id720_25_2_1_1_1() throws Exception {
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_2_1_1_1 Pass");
		}else{
			System.out.println("id720_25_2_1_1_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 **/
	@Test
	public void id720_25_2_1_1_2() throws Exception {
		dependentsNumber = changeEmployeeInfo(driver,"KO","more");
		int value = Integer.parseInt(String.valueOf(Math.random()*922000+88000).split("\\.")[0]);
		int dependents = Integer.parseInt(getCSVData("dependents"+dependentsNumber,value));
		inputPayment(driver,value);	
		//#id720= { WithholdingTaxAmount#koTaxAmountSevenDependents of the record } - (Employee#dependentsNumber - 7 )×1610. If the result amount < 0, 0. 
		int id720 =  (int)(dependents-(dependentsNumber-7)*1610);
		if(id720<0){
			id720 = 0;
		}
		//get value
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_2_1_1_2 Pass");
		}else{
			System.out.println("id720_25_2_1_1_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 **/
	@Test
	public void id720_25_2_1_2_1_1() throws Exception {
		dependentsNumber = changeEmployeeInfo(driver,"KO","less");
		int value = Integer.parseInt(String.valueOf(Math.random()*4000000+1740000).split("\\.")[0]);
		int dependents = Integer.parseInt(getCSVData("dependents"+dependentsNumber,value));
		double specialKouRate = Double.valueOf(getCSVData("specialKouRate",value));
		int V = inputPayment(driver,value);	
		//m = {one of which is WithholdingTaxAmount#koTaxAmountNoDependent 〜 #koTaxAmountSevenDependents at a record of (WithholdingTaxAmount#lowerBoundAmountIncluded=1740000 and WithholdingTaxAmount#startDate <= #paymentDate of the selected payrollMonth <= WithholdingTaxAmount#endDate ) according to Employee#dependentsNumber. } 
		//+ ( V - 1740000 ) × WithholdingTaxAmount#koSpecialTaxRate 
		int id720 =  (int)(dependents+(V-1740000)*specialKouRate);
		if(id720<0){
			id720 = 0;
		}
		//get value
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_2_1_2_1_1 Pass");
		}else{
			System.out.println("id720_25_2_1_2_1_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 **/
	@Test
	public void id720_25_2_1_2_1_2() throws Exception {
		dependentsNumber = changeEmployeeInfo(driver,"KO","more");
		int value = Integer.parseInt(String.valueOf(Math.random()*4000000+1740000).split("\\.")[0]);
		int dependents = Integer.parseInt(getCSVData("dependents"+dependentsNumber,value));
		double specialKouRate = Double.valueOf(getCSVData("specialKouRate",value));
		int V = inputPayment(driver,value);	
		//m = {WithholdingTaxAmount#koTaxAmountSevenDependents at record of ( WithholdingTaxAmount#lowerBoundAmountIncluded=1740000 and WithholdingTaxAmount#startDate <= #paymentDate of the selected payrollMonth <= WithholdingTaxAmount#endDate ) }
		//+ ( V - 1740000 ) × WithholdingTaxAmount#koSpecialTaxRate
		//- (Employee#dependentsNumber - 7 ) × 1610 
		int id720 =  (int)(dependents+(V-1740000)*specialKouRate-(dependentsNumber-7)*1610);
		if(id720<0){
			id720 = 0;
		}
		//get value
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_2_1_2_1_2 Pass");
		}else{
			System.out.println("id720_25_2_1_2_1_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 * If WithholdingTaxAmount#koSpecialCalculationFlag is true
	 * #id720 = m rounded down after decimal point. If the result amount < 0, 0.
	 * If 1,250,000 yen < V <1,740,000 yen
	 * Employee#dependentsNumber <= 7
	 **/
	@Test
	public void id720_25_2_1_2_2_1() throws Exception {
		dependentsNumber = changeEmployeeInfo(driver,"KO","less");
		int value = Integer.parseInt(String.valueOf(Math.random()*489999+1250001).split("\\.")[0]);
		int dependents = Integer.parseInt(getCSVData("dependents"+dependentsNumber,value));
		double specialKouRate = Double.valueOf(getCSVData("specialKouRate",value));
		int V = inputPayment(driver,value);	
		//m = {one of which is WithholdingTaxAmount#koTaxAmountNoDependent 〜 #koTaxAmountSevenDependents at record of ( WithholdingTaxAmount#lowerBoundAmountIncluded=1250000 and WithholdingTaxAmount#startDate <= #paymentDate of the selected payrollMonth <= WithholdingTaxAmount#endDate) according to Employee#dependentsNumber.}
		//+ ( V - 1250000円 ) × WithholdingTaxAmount#koSpecialTaxRate
		int id720 =  (int)(dependents+(V-1250000)*specialKouRate);
		if(id720<0){
			id720 = 0;
		}
		//get value
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_2_1_2_2_1 Pass");
		}else{
			System.out.println("id720_25_2_1_2_2_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 **/
	@Test
	public void id720_25_2_1_2_2_2() throws Exception {
		dependentsNumber = changeEmployeeInfo(driver,"KO","more");
		int value = Integer.parseInt(String.valueOf(Math.random()*489999+1250001).split("\\.")[0]);
		int dependents = Integer.parseInt(getCSVData("dependents"+dependentsNumber,value));
		double specialKouRate = Double.valueOf(getCSVData("specialKouRate",value));
		int V = inputPayment(driver,value);	
		//m = {WithholdingTaxAmount#koTaxAmountSevenDependents at record of ( WithholdingTaxAmount#lowerBoundAmountIncluded=1250000 and WithholdingTaxAmount#startDate <= #paymentDate of the selected payrollMonth <= WithholdingTaxAmount#endDate) }
		//+ ( V - 1250000円 ) × WithholdingTaxAmount#koSpecialTaxRate
		//- ( Employee#dependentsNumber - 7 ) × 1610
		int id720 =  (int)(dependents+(V-1250000)*specialKouRate-(dependentsNumber-7)*1610);
		if(id720<0){
			id720 = 0;
		}
		//get value
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_2_1_2_2_2 Pass");
		}else{
			System.out.println("id720_25_2_1_2_2_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 * If WithholdingTaxAmount#koSpecialCalculationFlag is true
	 * #id720 = m rounded down after decimal point. If the result amount < 0, 0.
	 * If 1,010,000 yen < V < 1,250,000 yen
	 * Employee#dependentsNumber <= 7
	 **/
	@Test
	public void id720_25_2_1_2_3_1() throws Exception {
		dependentsNumber = changeEmployeeInfo(driver,"KO","less");
		int value = Integer.parseInt(String.valueOf(Math.random()*239999+1010001).split("\\.")[0]);
		int dependents = Integer.parseInt(getCSVData("dependents"+dependentsNumber,value));
		double specialKouRate = Double.valueOf(getCSVData("specialKouRate",value));
		int V = inputPayment(driver,value);	
		//m = {one of which is WithholdingTaxAmount#koTaxAmountNoDependent 〜 #koTaxAmountSevenDependents at record of ( WithholdingTaxAmount#lowerBoundAmountIncluded=1250000 and WithholdingTaxAmount#startDate <= #paymentDate of the selected payrollMonth <= WithholdingTaxAmount#endDate) according to Employee#dependentsNumber.}
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_2_1_2_3_1 Pass");
		}else{
			System.out.println("id720_25_2_1_2_3_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 **/
	@Test
	public void id720_25_2_1_2_3_2() throws Exception {
		dependentsNumber = changeEmployeeInfo(driver,"KO","more");
		int value = Integer.parseInt(String.valueOf(Math.random()*239999+1010001).split("\\.")[0]);
		int dependents = Integer.parseInt(getCSVData("dependents"+dependentsNumber,value));
		double specialKouRate = Double.valueOf(getCSVData("specialKouRate",value));
		...
		//+ ( V - 1250000円 ) × WithholdingTaxAmount#koSpecialTaxRate
		//- ( Employee#dependentsNumber - 7 ) × 1610
		int id720 =  (int)(dependents+(V-1010000)*specialKouRate-(dependentsNumber-7)*1610);
		if(id720<0){
			id720 = 0;
		}
		//get value
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_2_1_2_3_2 Pass");
		}else{
			System.out.println("id720_25_2_1_2_3_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	 ...
	 **/
	@Test
	public void id720_25_2_2() throws Exception {
		...
		//check the data
		if(Common.formatNum(String.valueOf(id720)).equals(actual)){
			System.out.println("id720_25_2_2 Pass");
		}else{
			System.out.println("id720_25_2_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id720))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"id720 = "+ Common.formatNum(String.valueOf(id720))+"\r\n"+
					"actual = "+ actual+"\r\n"+
	...
	public static String getCSVData(String key,int value) throws Exception
	{
		...
		String filePath = file.getCanonicalPath()
				+ "\\resources\\pages\\testdata\\" + "WithholdingTaxAmount25.csv";
		...
		if(value>1010000){
			if(key.equals("otsuTaxAmount")){
				...
				if(value<1250000&&value>1010000){
					value = 1010000;					
				}else if(value<1740000&&value>1250000){
					value = 1250000;
				}else{
					value = 1740000;
				}
	...
	public static String getIncomeCSVData(String key,int value) throws Exception
	{
		File file = new File(".");
		String filePath = file.getCanonicalPath()
				+ "\\resources\\pages\\testdata\\" + "SpecialCasesCalculatorIncomeExemption25.csv";
		BufferedReader reader = new BufferedReader(new InputStreamReader(
				new FileInputStream(filePath), "Shift-JIS"));
		String line = null;
		//get max account of one line 
	...
	public static String getTaxCSVData(String key,int value) throws Exception
	{
		File file = new File(".");
		String filePath = file.getCanonicalPath()
				+ "\\resources\\pages\\testdata\\" + "SpecialCasesCalculatorTaxAmount25.csv";
		BufferedReader reader = new BufferedReader(new InputStreamReader(
				new FileInputStream(filePath), "Shift-JIS"));
		String line = null;
		//get max account of one line 
