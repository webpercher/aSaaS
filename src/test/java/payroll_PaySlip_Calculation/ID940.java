...
/**
 * Display the calculated value of payment amount by bank tranfer.
 **/
public class ID940 extends TestBase{
	...
	public void id940_1_1() throws Exception {
		...
		inputData(driver);
		//get value
		String actual = driver.findElement(By.xpath(paymentStatements.bankTransfer.xpath)).getAttribute("value");
		//check the data
		if(actual.isEmpty()){
	...
	public void id940_1_2() throws Exception {
		...
		//#id940 = #id930(balance payment amount)
		int id940 = id930;
		//get value
		String actual = driver.findElement(By.xpath(paymentStatements.bankTransfer.xpath)).getAttribute("value");
		//check the data
		if(Common.formatNum(String.valueOf(id940)).equals(actual)){
			System.out.println("id940_1_2 Pass");
		}else{
			System.out.println("id940_1_2 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id940))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
	...
	public void id940_2() throws Exception {
		changeEmployeeInfo(driver,"bankTranfer");
		int id930 = inputData(driver);
		int id950 = (int)(Math.random()*1000000);
		//#id940 = #id930(balance payment amount) - #id950(balance payment amount by bank transfer)
		int id940 = id930-id950;
		//input the value
		Common.clear(driver,paymentStatements.cashPayment.xpath);		
		driver.findElement(By.xpath(paymentStatements.cashPayment.xpath)).sendKeys(String.valueOf(id950));
		Thread.sleep(1000);
		for(int a = 0;a<30;a++){
			if(!driver.findElement(By.xpath(paymentStatements.bankTransfer.xpath)).getAttribute("value").equals(Common.formatNum(String.valueOf(id940)))){
