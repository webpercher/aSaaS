...
/**
 * Display the calculated value of payment amount by cash.
 **/
public class ID950 extends TestBase{
	...
	/**
	 * If payroll month is unlocked and the stored #id930 is not same with the calculated #id930, or when [recalculate] is clicked in locked month.
	 * If Employee#bonusPaymentType is "cash" 
	 **/
	@Test
	public void id950_1_1() throws Exception {
		changeEmployeeInfo(driver,"cash");
		int id930 = inputData(driver);
		//#id950 = #id930(balance payment amount)
		int id950 = id930;
		//get value
		String actual = driver.findElement(By.xpath(paymentStatements.cashPayment.xpath)).getAttribute("value");
		//check the data
		if(Common.formatNum(String.valueOf(id950)).equals(actual)){
			System.out.println("id950_1_1 Pass");
		}else{
			System.out.println("id950_1_1 Failed");
			throw new Exception("Error of calculation, expected: <["+Common.formatNum(String.valueOf(id950))+"]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = "+ Common.formatNum(String.valueOf(id950))+"\r\n"+
					"actual = "+ actual);
		}
		//close
	...
	public void id950_1_2() throws Exception {
		changeEmployeeInfo(driver,"bankTranfer");
		inputData(driver);
		//get value
		String actual = driver.findElement(By.xpath(paymentStatements.cashPayment.xpath)).getAttribute("value");
		//check the data
		//Bug #53083 so use second 
//		if(actual.isEmpty()){
...
//		}
		if(actual.equals("0")){
			...
			System.out.println("id950_1_2 Failed");
			throw new Exception("Error of calculation, expected: <[0]> but was: <["+actual+"]> , " +
					"Please refer to input and output values below: "+"\r\n"+
					"expected = 0"+"\r\n"+
					"actual = "+ actual);
		}
	...
	/**
	 * If payroll month is unlocked and #id950 is altered manually
	 **/
	@Test
	public void id950_2() throws Exception {
		changeEmployeeInfo(driver,"bankTranfer");
		int id930 = inputData(driver);
		int id940 = (int)(Math.random()*1000000);
		//#id950 = #id930(balance payment amount) - #id940(balance payment amount by bank transfer)
		int id950 = id930-id940;
		//input the value
		Common.clear(driver,paymentStatements.bankTransfer.xpath);		
		driver.findElement(By.xpath(paymentStatements.bankTransfer.xpath)).sendKeys(String.valueOf(id940));
		Thread.sleep(1000);
		for(int a = 0;a<30;a++){
			if(!driver.findElement(By.xpath(paymentStatements.cashPayment.xpath)).getAttribute("value").equals(Common.formatNum(String.valueOf(id950)))){
	...
	public static void changeEmployeeInfo(WebDriver driver,String type) throws Exception{
		...
		if(type=="cash"){
			...
			driver.findElement(By.xpath(employeeSetting.salaryBankTransfer.xpath)).click();
			Thread.sleep(2000);
		}
		//click the 'Save' button
	...
	public static int inputData(WebDriver driver) throws Exception{
